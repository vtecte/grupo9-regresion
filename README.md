...
2. analisis.R: Script de R
3. grupo9_regresion.Rproj: Enviroment para trabajar en R
4. informe_avance.zip: Informe con plantilla. Para visualizar subir como proyecto en Overleaf. 
